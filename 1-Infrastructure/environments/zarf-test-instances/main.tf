...
module "zarf-test-1" {
  ...
  zarf_command = "sudo zarf package deploy zarf-init-amd64-v0.29.0.tar.zst --components=k3s,zarf-injector,zarf-seed-registry,zarf-registry,zarf-agent,git-server --confirm"
